            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="index.php"><img src="img/logo.png" alt=""></a>
                        <div class="logo-user">
                            <a href="IHM/loginForm.php"> <img src="img/clients/user.png" alt="logo user"> </a>
                ...
                <div class="col-lg-10">
                    <div class="header__nav">
                        ...
                        <div class="header__nav__widget">
                            ...
                            <a href="IHM/loginForm.php" class="primary-btn">Se connecter</a>
                        </div>
                        <a href="IHM/loginForm.php" class="inscription"> Inscription </a>
                    </div>
                </div>
            </div>
